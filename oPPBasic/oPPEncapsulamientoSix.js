console.group("Encapsulamiento");
// ==== (2) ENCAPSULAMIENTO  >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
// Guardianes >> Intercepción =>
// > No permitir alteración de métodos y atributos >>>>>>>>>
// 1- Getters y Setters (Permite acceder o no acceder) / 2- Namespaces / 3- Object.defineProperties / 4- Módulos de ES6 >>>>>>>
// Getters y Setters ===> Público y Privado / Acceso>
// Getters y Setters ===> (._name) >>> gUIÓN bAJO.
// ======================== ======================================================================== =========== >
